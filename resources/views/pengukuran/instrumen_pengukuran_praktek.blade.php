          ...
          <div class="card-header pb-0 p-3">
                  <div class="row">
                    ...
                    <label class="form-label">Perawat dalam membuat keputusan wajib didasarkan pada informasi yang akurat</label>
                      ...
                      <div class="input-group input-group-outline mb-2">
                      <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="options10" id="radio19" value="1">
                        <label class="form-check-label" for="radio19">Ya</label>
                        </div>
                        <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="options10" id="radio20" value="0">
                    ...
                    <label class="form-label">Perawat dilarang menyampaikan hal-hal yang terkait dengan kegiatan profesi keperawatan, kecuali ditugaskan oleh pejabat yang berwenang</label>
                      <div class="input-group input-group-outline mb-2">
                      <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="options11" id="radio21" value="1">
                        <label class="form-check-label" for="radio21">Ya</label>
                        </div>
                        <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="options11" id="radio22" value="0">
                      ...
                      <div class="input-group input-group-outline mb-2">
                      <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="options12" id="radio23" value="1">
                        <label class="form-check-label" for="radio23">Ya</label>
                        </div>
                        <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="options12" id="radio24" value="0">
                      ...
                      <div class="input-group input-group-outline mb-2">
                      <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="options13" id="radio25" value="1">
                        <label class="form-check-label" for="radio25">Ya</label>
                        </div>
                        <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="options13" id="radio26" value="0">
                      ...
                      <div class="input-group input-group-outline mb-2">
                      <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="options14" id="radio27" value="1">
                        <label class="form-check-label" for="radio27">Ya</label>
                        </div>
                        <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="options14" id="radio28" value="0">
                      ...
                      <div class="input-group input-group-outline mb-2">
                      <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="options15" id="radio29" value="1">
                        <label class="form-check-label" for="radio29">Ya</label>
                        </div>
                        <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="options15" id="radio30" value="0">
