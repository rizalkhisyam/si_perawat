          ...
          <div class="card-header pb-0 p-3">
                  <div class="row">
                    <div class="col-12 d-flex align-items-center justify-content-center mb-2">
                      <h6 class="mb-0">Perhitungan Skor - Perawat dan Praktek</h6>
                    </div>
                    ...
                    <ul class="list-group mt-5">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <span class="mb-2 text-xs">Nilai Maksimal : <span class="text-dark ms-sm-2 font-weight-bold">20 {{$total}}</span></span>
                        </div>
                        </li>
                    </ul>
