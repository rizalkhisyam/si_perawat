                  ...
                  <div class="row">
                    ...
                    <ul class="list-group mb-2">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <span class="mb-2 text-xs">Nilai Maksimal : <span class="text-dark ms-sm-2 font-weight-bold">20</span></span>
                            ...
                            <span class="mb-2 text-xs">Nilai Maksimal : <span class="text-dark ms-sm-2 font-weight-bold">6</span></span>
                            ...
                            <span class="mb-2 text-xs">Nilai Maksimal : <span class="text-dark ms-sm-2 font-weight-bold">10</span></span>
                        </div>
                        </li>
                    </ul>
                    <ul class="list-group mb-2">
